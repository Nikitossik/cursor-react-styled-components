...
import icon from '../assets/padlock.svg';
...
export default function SignIn() {
	...
	if (authorized) {
		return <Redirect to="/cursor-react-styled-components/home" />
	}
	if (signedIn) {
            ...
            <Form className='sign-in'>
                ...
                <div className="form-footer">
                    ...
                    <div className="form-redirect">
                        ...
                        <Link onClick={handleSignUp} className='redirect-link' to='/cursor-react-styled-components/sign-up'>Don't have an account? Sign up</Link>
                    </div>
                </div>
            </Form>
        </Wrapper>
